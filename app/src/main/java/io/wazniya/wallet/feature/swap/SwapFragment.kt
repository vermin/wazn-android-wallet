...
import io.wazniya.wallet.dialog.ExtraIDPromptDialog
import io.wazniya.wallet.dialog.PickerDialog
import io.wazniya.wallet.dialog.SwapRiskDialog
import io.wazniya.wallet.feature.address.ScanActivity
import io.wazniya.wallet.feature.auth.AuthManager
import io.wazniya.wallet.support.*
import io.wazniya.wallet.support.extensions.*
import io.wazniya.wallet.widget.IOSDialog
import io.wazniya.wallet.widget.MaterialProgressDrawable
...
class SwapFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.balance.observe(this, Observer { value ->
            value?.let {
                clearFocus()
                balance.text = "${it.decimalFormat()} WAZN"
            }
        })
        ...
        AppDatabase.getInstance().walletDao().loadActiveWallet().observe(this, Observer { wallet ->
            wallet?.let {
                walletId = it.id
                balance.text = "${it.balance.decimalFormat()} WAZN"
        ...
        WAZNWalletController.stopWallet.observe(this, Observer {
            if (it != null) {
