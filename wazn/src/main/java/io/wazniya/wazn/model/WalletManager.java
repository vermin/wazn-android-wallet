...
package io.wazniya.wazn.model;


import android.util.Log;
import io.wazniya.wazn.data.Node;
import io.wazniya.wazn.ledger.Ledger;
...
public class WalletManager {
    ...
    public Wallet.Device queryWalletDevice(String keys_file_name, String password) {
        ...
        return Wallet.Device.values()[device + 1]; // mapping is wazn+1=android
    }
...
//TODO static std::tuple<bool, std::string, std::string, std::string, std::string> checkUpdates(const std::string &software, const std::string &subdir);
    ...
    //TODO: maybe put these in an enum like in wazn core - but why?
