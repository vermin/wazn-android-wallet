...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *jvm, void *reserved) {
    ...
    class_TransactionInfo = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("io/wazniya/wazn/model/TransactionInfo")));
    class_Transfer = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("io/wazniya/wazn/model/Transfer")));
...
Java_io_wazniya_wazn_model_WalletManager_createWalletJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_io_wazniya_wazn_model_WalletManager_openWalletJ(JNIEnv *env, jobject instance,
                                                      jstring path, jstring password,
                                                      jint networkType) {
    const char *_path = env->GetStringUTFChars(path, NULL);
    const char *_password = env->GetStringUTFChars(password, NULL);
...
JNIEXPORT jlong JNICALL
Java_io_wazniya_wazn_model_WalletManager_recoveryWalletJ(JNIEnv *env, jobject instance,
                                                          jstring path, jstring password,
                                                          jstring mnemonic,
                                                          jint networkType,
                                                          jlong restoreHeight) {
...
JNIEXPORT jlong JNICALL
Java_io_wazniya_wazn_model_WalletManager_createWalletFromKeysJ(JNIEnv *env, jobject instance,
                                                                jstring path, jstring password,
                                                                jstring language,
                                                                jint networkType,
                                                                jlong restoreHeight,
...
JNIEXPORT jlong JNICALL
Java_io_wazniya_wazn_model_WalletManager_createWalletFromDeviceJ(JNIEnv *env, jobject instance,
                                                                  jstring path,
                                                                  jstring password,
                                                                  jint networkType,
                                                                  jstring deviceName,
...
Java_io_wazniya_wazn_model_WalletManager_walletExists(JNIEnv *env, jobject instance,
                                                       jstring path) {
    const char *_path = env->GetStringUTFChars(path, NULL);
    bool exists =
...
JNIEXPORT jboolean JNICALL
Java_io_wazniya_wazn_model_WalletManager_verifyWalletPassword(JNIEnv *env, jobject instance,
...
Java_io_wazniya_wazn_model_WalletManager_queryWalletDeviceJ(JNIEnv *env, jobject instance,
                                                             jstring keys_file_name,
                                                             jstring password) {
    const char *_keys_file_name = env->GetStringUTFChars(keys_file_name, NULL);
    const char *_password = env->GetStringUTFChars(password, NULL);
...
Java_io_wazniya_wazn_model_WalletManager_findWallets(JNIEnv *env, jobject instance,
                                                      jstring path) {
    const char *_path = env->GetStringUTFChars(path, NULL);
...
JNIEXPORT jint JNICALL
Java_io_wazniya_wazn_model_WalletManager_getDaemonVersion(JNIEnv *env,
                                                           jobject instance) {
    uint32_t version;
    bool isConnected =
...
JNIEXPORT jboolean JNICALL
Java_io_wazniya_wazn_model_WalletManager_startMining(JNIEnv *env, jobject instance,
                                                      jstring address,
...
JNIEXPORT jstring JNICALL
Java_io_wazniya_wazn_model_WalletManager_resolveOpenAlias(JNIEnv *env, jobject instance,
                                                           jstring address,
...
JNIEXPORT jboolean JNICALL
Java_io_wazniya_wazn_model_Wallet_initJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jboolean JNICALL
Java_io_wazniya_wazn_model_Wallet_isAddressValid(JNIEnv *env, jclass clazz,
...
JNIEXPORT jstring JNICALL
Java_io_wazniya_wazn_model_Wallet_getPaymentIdFromAddress(JNIEnv *env, jclass clazz,
                                                           jstring address,
                                                           jint networkType) {
    Wazn::NetworkType _networkType = static_cast<Wazn::NetworkType>(networkType);
    const char *_address = env->GetStringUTFChars(address, NULL);
...
JNIEXPORT jlong JNICALL
Java_io_wazniya_wazn_model_Wallet_createTransactionJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_io_wazniya_wazn_model_Wallet_createSweepTransaction(JNIEnv *env, jobject instance,
                                                          jstring dst_addr, jstring payment_id,
                                                          jint mixin_count,
                                                          jint priority,
                                                          jint accountIndex) {
...
JNIEXPORT jboolean JNICALL
Java_io_wazniya_wazn_model_Wallet_setUserNote(JNIEnv *env, jobject instance,
...
JNIEXPORT jstring JNICALL
Java_io_wazniya_wazn_model_Wallet_getUserNote(JNIEnv *env, jobject instance,
                                               jstring txid) {
...
JNIEXPORT jstring JNICALL
Java_io_wazniya_wazn_model_Wallet_getTxKey(JNIEnv *env, jobject instance,
                                            jstring txid) {
...
JNIEXPORT void JNICALL
Java_io_wazniya_wazn_model_Wallet_addAccount(JNIEnv *env, jobject instance,
                                              jstring label) {
...
JNIEXPORT void JNICALL
Java_io_wazniya_wazn_model_Wallet_setSubaddressLabel(JNIEnv *env, jobject instance,
                                                      jint accountIndex, jint addressIndex,
                                                      jstring label) {
...
JNIEXPORT void JNICALL
Java_io_wazniya_wazn_model_Wallet_addSubaddress(JNIEnv *env, jobject instance,
                                                 jint accountIndex,
                                                 jstring label) {
...
JNIEXPORT jboolean JNICALL
Java_io_wazniya_wazn_model_PendingTransaction_commit(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_io_wazniya_wazn_model_WalletManager_initLogger(JNIEnv *env, jclass clazz,
                                                     jstring argv0,
...
JNIEXPORT void JNICALL
Java_io_wazniya_wazn_model_WalletManager_logDebug(JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_io_wazniya_wazn_model_WalletManager_logInfo(JNIEnv *env, jclass clazz,
                                                  jstring category, jstring message) {
...
JNIEXPORT void JNICALL
Java_io_wazniya_wazn_model_WalletManager_logWarning(JNIEnv *env, jclass clazz,
                                                     jstring category, jstring message) {
...
JNIEXPORT void JNICALL
Java_io_wazniya_wazn_model_WalletManager_logError(JNIEnv *env, jclass clazz,
                                                   jstring category, jstring message) {
